...
from networks.model.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
from networks.model.base_model import build_backbone


class FCN_ResNet(nn.Module):
    def __init__(self, in_ch , out_ch, backbone='resnet18', out_stride=32, mult_grid=False):
        ...
        if backbone == 'resnet18' or backbone == 'resnet34':
            ...
            expansion = 4
        self.backbone = build_backbone(backbone, out_stride, mult_grid, in_ch = in_ch)
