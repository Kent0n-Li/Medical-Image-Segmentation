...
class ResNet(nn.Module):
    def __init__(self, block, layers, os=16, in_ch=1):
        self.inplanes = 64
...
def Deeplabv3plus_res50(in_ch, out_ch, os=16, pretrained=False):
    num_classes = out_ch
    resnet50 = ResNet(Bottleneck, [3, 4, 6, 3], os, in_ch=in_ch)
