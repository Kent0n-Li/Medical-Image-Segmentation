...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, out_stride, mult_grid, in_ch):
        self.inplanes = 64
...
def resnet18(out_stride=32, mult_grid=False, in_ch=1):
    """Constructs a ResNet-18 model."""
    model = ResNet(BasicBlock, [2, 2, 2, 2], out_stride, mult_grid, in_ch)

    return model


def resnet34(out_stride=32, mult_grid=False, in_ch=1):
    """Constructs a ResNet-34 model."""
    model = ResNet(BasicBlock, [3, 4, 6, 3], out_stride, mult_grid, in_ch)
 
    return model


def resnet50(out_stride=32, mult_grid=False, in_ch=1):
    """Constructs a ResNet-50 model."""
    model = ResNet(Bottleneck, [3, 4, 6, 3], out_stride, mult_grid, in_ch)

    return model


def resnet101(out_stride=32, mult_grid=False, in_ch=1):
    """Constructs a ResNet-101 model."""
    model = ResNet(Bottleneck, [3, 4, 23, 3], out_stride, mult_grid, in_ch)
    return model


def resnet152(out_stride=32, mult_grid=False, in_ch=1):
    """Constructs a ResNet-152 model."""
    model = ResNet(Bottleneck, [3, 8, 36, 3], out_stride, mult_grid, in_ch)
    return model
